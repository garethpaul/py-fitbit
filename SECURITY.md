...
Protected Fitbit resource calls should be passed as API paths such as `/1/user/-/profile.json`. The sample rejects absolute URLs and scheme-relative URLs before opening a network connection.
